...
function CreateAmount({ createAmountOpen, setCreateAmountOpen, getAmounts }) {
  const [amountName, setAmountName] = useState("");
  const handleClose = () => setCreateAmountOpen(false);
  async function handleCreateAmount() {
    const data = {
      name: amountName,
    };
